          ...
          <div class="box-body table-responsive no-padding">
            ...
            ?>
              <tr>
                ...
                <td><a class="btn btn-info" href="editkosuser.php?idkos=<?php echo $row['idkos']; ?>"><span class="fa fa-pencil "></span> Edit</a> &nbsp;<a class="btn btn-danger deletelink" href="hapuskosuser.php?idkos=<?php echo $row['idkos']; ?>"><span class="fa fa-trash "></span> Hapus</a></td>
              </tr>
            <?php endwhile; ?>
            </table>
          </div>
