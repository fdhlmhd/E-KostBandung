  ...
  <div class="login-box-body">
    ...
    <form action="cekloginadmin.php" method="POST">
      <div class="form-group has-feedback">
        ...
        <input type="text" name="nama" class="form-control" placeholder="Username"></div>
      <div class="form-group has-feedback">
          <span class="glyphicon glyphicon-lock form-control-feedback pull-left"></span>
        <input type="password" name="password" class="form-control" placeholder="Password"></div>
      <div class="row">
        <div class="col-md-12 pull-right">
          <input type="submit" name="submitadmin" class="btn btn-primary btn-block btn-flat" value="Login"></div>
     </form><br><br>
      </div></div></div>
