                    ...
                    <div class="box-body">
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" name="nama" class="form-control" placeholder="Username Anda"></div>
                      </div>
                      <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon">
                      ...
                      <div class="input-group">
                          <div class="input-group-addon">
                            ...
                            <input type="text" name="passwordbaru" class="form-control" placeholder="Password Baru Anda"></div>
                        </div>
                      <div class="pull-right">
                        <button type="reset" class="btn btn-danger">Hapus</button>
                        <input type="submit" name="submit" class="btn btn-primary" value="Ganti"></div>
                  </form></div></section>
    </div>
